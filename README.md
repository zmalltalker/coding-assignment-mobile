...
This document describes one of the challenges for those interested in working with us. As you may have guessed, it revolves around mobile apps. :tada:

## 🤖 Using AI Coding Agents? Read This First!

**We encourage you to use AI coding assistants** (Claude, ChatGPT, GitHub Copilot, etc.) for this challenge. However, **you must document and submit all your AI interactions** as part of your solution.

**👉 Please read [AGENTS.md](AGENTS.md) for complete instructions on how to track and submit your AI conversation history.**

This is a required part of your submission and helps us understand your problem-solving approach and how you work with modern development tools.
...
- **your AI conversation history** (see [AGENTS.md](AGENTS.md) - **required**),
